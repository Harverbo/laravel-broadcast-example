...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    changeStatus: function changeStatus(online_user, status) {
      var index = this.users.findIndex(function (user) {
        return user.id === online_user.id;
      });
  ...
  mounted: function mounted() {
    ...
    this.users.forEach(function (user, index) {
      _this.$set(_this.users[index], "online", false);
    });
    Echo.join("status").here(function (users) {
      users.forEach(function (user) {
        _this.changeStatus(user, true);
      });
    }).joining(function (user) {
      _this.changeStatus(user, true);
    }).leaving(function (user) {
      _this.changeStatus(user, false);
    });
  },
  props: {
    usersArray: Array
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.users, function(user) {
      return _c(
        "div",
        { key: user.id, staticClass: "bg-grey-100 shadow mb-4 py-4" },
        [
          _c(
            "span",
            {
              staticClass: "rounded ml-2",
              class: { "bg-green-600": user.online, "bg-red-600": !user.online }
            },
            [_vm._v("\n      " + _vm._s(_vm.userStatus(user)) + "\n    ")]
          ),
          _vm._v("\n    -\n    "),
...
__webpack_require__(/*! /home/harverbo/Proyectos/laravel-broadcast-example/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/harverbo/Proyectos/laravel-broadcast-example/resources/sass/app.scss */"./resources/sass/app.scss");
